...
Download the latest build `v2.5.0` from the [Releases page](https://github.com/GameTechDev/XeSSInspector/releases).
...
- The target application must have an XeSS technology integrated (XeSS-SR, XeSS-FG or XeLL).
